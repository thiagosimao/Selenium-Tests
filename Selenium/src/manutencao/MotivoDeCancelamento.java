...
public class MotivoDeCancelamento {
	...
	@Test
	public void testMotivoDeCancelamento() throws Exception {
		...
		driver.findElement(By.xpath("//html/body/div[2]/div/div/div/div/div/ul/li[3]/ul/li[4]/ul/li/a")).click();
		...
		String cancelKey = "Cancel_" + (int) Math.floor(Math.random() * 1000);
		driver.findElement(By.id("key")).clear();
		driver.findElement(By.id("key")).sendKeys(cancelKey);
		driver.findElement(By.xpath("//div[2]/div[3]/div/div[2]/div/div")).click();
		driver.findElement(By.xpath("//html/body/ul[5]/li/a")).click();
		driver.findElement(By.id("description")).sendKeys("Cancel_" + (int) Math.floor(Math.random() * 1000));
		...
		driver.findElement(By.id("searchFilter")).sendKeys(cancelKey);
		...
		cancelKey = "Cancel_" + (int) Math.floor(Math.random() * 1000);
		driver.findElement(By.id("key")).clear();
		driver.findElement(By.id("key")).sendKeys(cancelKey);
		driver.findElement(By.xpath("//div[2]/div[3]/div/div[2]/div/div")).click();
		driver.findElement(By.xpath("//html/body/ul[5]/li/a")).click();
