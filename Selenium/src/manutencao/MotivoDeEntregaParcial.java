...
public class MotivoDeEntregaParcial {
	...
	@Test
	public void testMotivoDeEntregaParcial() throws Exception {
		...
		driver.findElement(By.xpath("//html/body/div[2]/div/div/div/div/div/ul/li[3]/ul/li[4]/ul/li[2]/a")).click();
		...
		String reasonDesc = "Reason_" + (int) Math.floor(Math.random() * 1000);
		driver.findElement(By.id("description")).clear();
		driver.findElement(By.id("description")).sendKeys(reasonDesc);
		...
		driver.findElement(By.id("shorts")).click();
		driver.findElement(By.id("pickup")).click();
		driver.findElement(By.id("over")).click();
		driver.findElement(By.id("damaged")).click();
		...
		driver.findElement(By.id("searchFilter")).sendKeys(reasonDesc);
		...
		driver.findElement(By.id("over")).click();
		driver.findElement(By.id("damaged")).click();
		reasonDesc = "Reason_" + (int) Math.floor(Math.random() * 1000);
		driver.findElement(By.id("description")).clear();
		driver.findElement(By.id("description")).sendKeys(reasonDesc);
		driver.findElement(By.xpath("//form/div[2]/div[4]/div/div/div/div")).click();
		driver.findElement(By.xpath("//html/body/ul[5]/li/a")).click();
