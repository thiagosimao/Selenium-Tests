...
public class TiposDeHorasDeServico {
	...
	@Test
	public void testTiposDeHorasDeServico() throws Exception {
		...
		driver.findElement(By.xpath("//html/body/div[2]/div/div/div/div/div/ul/li[3]/ul/li[9]/ul/li/a")).click();

		// Adicionar Tipos de Horas de Serviço
		for (int second = 0;; second++) {
			if (second >= 60)
				fail("timeout");
			try {
		...
		String hoursTypeDesc = "HoursOfServiceType_" + (int) Math.floor(Math.random() * 10000);
		driver.findElement(By.id("description")).clear();
		driver.findElement(By.id("description")).sendKeys(hoursTypeDesc);
		...
		driver.findElement(By.id("allowBreakAppointment")).click();
		driver.findElement(By.id("allowWaitAppointment")).click();
		driver.findElement(By.id("allowLunchAppointment")).click();
		driver.findElement(By.id("inferDriveTimeBasedRouteActions")).click();
		driver.findElement(By.id("btn_save")).click();

		// Editar Tipo de Horas de Serviço
		for (int second = 0;; second++) {
			if (second >= 60)
				fail("timeout");
			try {
		...
		driver.findElement(By.id("searchFilter")).sendKeys(hoursTypeDesc);
		Thread.sleep(3000);
		...
		driver.findElement(By.id("allowLunchAppointment")).click();
		driver.findElement(By.id("inferDriveTimeBasedRouteActions")).click();
		hoursTypeDesc = "HoursOfServiceType_" + (int) Math.floor(Math.random() * 10000);
		driver.findElement(By.id("description")).clear();
		driver.findElement(By.id("description")).sendKeys(hoursTypeDesc);
		driver.findElement(By.xpath("//form/div[2]/div[4]/div/div[1]/div/div")).click();
		driver.findElement(By.xpath("//html/body/ul[5]/li/a")).click();
		...
		// Excluir Tipo de Horas de Serviço
		for (int second = 0;; second++) {
			if (second >= 60)
				fail("timeout");
			try {
