...
public class TiposDeLocalidade {
	...
	@Test
	public void testTiposDeLocalidade() throws Exception {
		...
		driver.findElement(By.xpath("//html/body/div[2]/div/div/div/div/div/ul/li[3]/ul/li[6]/ul/li[2]/a")).click();

		// Adicionar Tipos de Localidades
		for (int second = 0;; second++) {
			if (second >= 60)
				fail("timeout");
			try {
		...
		String localeTypeKey = "LocaleTypes_" + (int) Math.floor(Math.random() * 1000);
		driver.findElement(By.id("description")).clear();
		driver.findElement(By.id("description")).sendKeys("LocaleTypes_" + (int) Math.floor(Math.random() * 1000));
		driver.findElement(By.id("key")).clear();
		driver.findElement(By.id("key")).sendKeys(localeTypeKey);
		...
		driver.findElement(By.id("searchFilter")).sendKeys(localeTypeKey);
